...
public class CustomerBuyPage1Controller {

    private Scene logoutScene, customerBuyPage2Scene;
    ...
    public void setNextPageScene(Scene scene) {
        this.customerBuyPage2Scene = scene;
    }

    @FXML
    public void nextPageSceneSwitch(MouseEvent actionEvent) {
        Stage primaryStage = (Stage)((Node)actionEvent.getSource()).getScene().getWindow();
        primaryStage.setScene(customerBuyPage2Scene);
    }
