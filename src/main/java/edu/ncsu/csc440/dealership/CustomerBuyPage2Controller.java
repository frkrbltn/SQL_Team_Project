...
public class CustomerBuyPage2Controller {

    private Scene logoutScene, customerBuyPage3Scene;
    ...
    public void setNextPageScene(Scene scene) {
        this.customerBuyPage3Scene = scene;
    }

    @FXML
    public void nextPageSceneSwitch(MouseEvent actionEvent) {
        Stage primaryStage = (Stage)((Node)actionEvent.getSource()).getScene().getWindow();
        primaryStage.setScene(customerBuyPage3Scene);
    }
